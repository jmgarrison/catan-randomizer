...
class ResourceUrlResolverWrapper implements ResourceUrlResolver {
  ...
  ResourceUrlResolverWrapper(this._uriMapper, this._config): _baseUri = _getBaseUri();

  ResourceUrlResolverWrapper.forTests(this._uriMapper, this._config, this._baseUri);
